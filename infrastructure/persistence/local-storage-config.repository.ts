...
const DEFAULTS: PersistedConfig = { activePlaylist: 'gregorian', soundEnabled: true, autoPlay: true, soundVolume: 80, musicVolume: 80, showBreakTips: true, interfaceMode: 'simple', askForOccasionalFeedback: true };
  ...
  load(): PersistedConfig | null {
    ...
    try {
      ...
      return { activePlaylist: isMusicOptionId(migratedPlaylist) ? migratedPlaylist : DEFAULTS.activePlaylist,
        ...
        interfaceMode, askForOccasionalFeedback: typeof value.askForOccasionalFeedback === 'boolean' ? value.askForOccasionalFeedback : true };
    } catch {
      this.clear();
      return null;
    }
