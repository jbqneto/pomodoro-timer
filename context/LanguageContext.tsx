...
const translations = {
  en: {
    ...
    abandonCycleTitle: 'Abandon this cycle?',
    abandonCycleDescription: 'This returns to focus session 1 without recording the current phase.',
    cancel: 'Cancel',
    ...
    classical: 'Classical',
    silence: 'Silence',
    gregorian: 'Contemplative Chants',
    musicCategory: 'Music category',
    silenceDescription: 'No external media is loaded in silence mode.',
    ...
    gregorianSubtitle: 'Contemplative chants for longer sessions',
    ...
    settings: 'Settings',
    settingsDescription: 'Configure timer presets and audio preferences.',
    close: 'Close',
  ...
  pt: {
    ...
    abandonCycleTitle: 'Abandonar este ciclo?',
    abandonCycleDescription: 'Isso retorna à sessão 1 de foco sem registrar a fase atual.',
    cancel: 'Cancelar',
    ...
    classical: 'Clássica',
    silence: 'Silêncio',
    gregorian: 'Cantos contemplativos',
    musicCategory: 'Categoria de música',
    silenceDescription: 'Nenhuma mídia externa é carregada no modo silêncio.',
    ...
    gregorianSubtitle: 'Cantos contemplativos para sessões longas',
    ...
    settingsDescription: 'Configure os presets do timer e as preferências de áudio.',
    close: 'Fechar',
